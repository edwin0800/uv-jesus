...
class ModeloComercio{
	...
	static public function mdlActualizarColores($tabla, $id, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET barraSuperior = :barraSuperior, textoSuperior = :textoSuperior, colorFondo = :colorFondo, colorPlantilla = :colorPlantilla, colorTexto = :colorTexto  WHERE id = :id");
		...
		$stmt->bindParam(":colorPlantilla", $datos["colorPlantilla"], PDO::PARAM_STR);
