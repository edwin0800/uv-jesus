...
// ACTIVAR PRODUCTO
// =============================================*/
// $('.tablaProductos tbody').on("click", ".btnActivarAdmin", function(){

// 	var idProducto = $(this).attr("idProducto");
// 	var estadoProductoAdmin = $(this).attr("estadoProductoAdmin");

// 	var datos = new FormData();
//  	datos.append("activarId", idProducto);
// 	datos.append("activarProductoAdmin", estadoProductoAdmin);
...
// 	if(estadoProductoAdmin == 0){

//   		$(this).removeClass('btn-success');
//   		$(this).addClass('btn-danger');
//   		$(this).html("<i class='fa fa-ban'></i>");
//   		$(this).attr('estadoProductoAdmin',1);
// 		$(this).parent().parent().parent().parent().parent().addClass("bg-danger");
//   	}else{
//   		$(this).addClass('btn-success');
//   		$(this).removeClass('btn-danger');
//   		$(this).html("<i class='fa fa-bullseye'></i>");
// 		$(this).attr('estadoProductoAdmin',0);
// 		$(this).parent().parent().parent().parent().parent().removeClass("bg-danger");
