...
<ul class="sidebar-menu">
    ...
    <a href="inicio" class="logo">
      <span class="logo-lg"><img src="vistas/img/plantilla/logo.png" class="img-responsive" style="padding:1px; filter:contrast(200%);"></span>
    </a>
    <!-- logo --></li>
  ...
  ?>
	...
	<li class="treeview">
      ...
      <a href="#">
        <i class="fa fa-th"></i>
        <span class="h5">Gestor Categorías</span>
        <span class="pull-right-container" style="height: 2px; margin-top:2px !important;">
