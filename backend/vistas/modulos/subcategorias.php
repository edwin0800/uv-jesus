          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <textarea type="text" maxlength="120" class="form-control input-lg"  name="descripcionSubCategoria" rows="3" placeholder="Ingresar descripción subcategoría (se recomienda no superar los 200 caracteres)" required></textarea>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg tagsInput" data-role="tagsinput"  name="pClavesSubCategoria" placeholder="Ingresar palabras claves (se recomienda no superar mas de 30 palabras clave)" required>
