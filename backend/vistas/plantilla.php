...
<head>
  ...
  <link rel="stylesheet" href="vistas/dist/css/skins/skin-green.min.css">
  <link rel="stylesheet" href="vistas/dist/css/skins/skin-purple.min.css">
  ...
  <link rel="stylesheet" href="vistas/dist/css/skins/skin-green-light.min.css">
  <link rel="stylesheet" href="vistas/dist/css/skins/skin-purple-light.min.css">
  <link rel="stylesheet" href="vistas/dist/css/skins/skin-red-light.min.css">
  ...
  <script src="vistas/plugins/jvectormap/jquery-jvectormap-ve-mill.js"></script>
...
<?php
 ...
 if(isset($_SESSION["validarSesionBackend"]) && $_SESSION["validarSesionBackend"] === "ok"){
    ...
    echo '<body class="hold-transition skin-purple sidebar-collapse sidebar-mini login-page">
  ...
  echo '<body class="hold-transition skin-blue sidebar-collapse sidebar-mini login-page" style="background: url(vistas/img/login/office2.jpg); background-size: cover;">';
