...
class ModeloUsuarios{
	...
	static public function mdlMostrarComentariosPerfil($tabla, $datos){
		...
		if($datos["idUsuario"] != ""){
			...
			$stmt = Conexion2::conectar2()->prepare("SELECT * FROM $tabla WHERE id_usuario = :id_usuario AND id_producto = :id_producto");
			...
			$stmt = Conexion2::conectar2()->prepare("SELECT * FROM $tabla WHERE id_producto = :id_producto ORDER BY Rand()");
	...
	static public function mdlActualizarComentario($tabla, $datos){
		...
		$stmt = Conexion2::conectar2()->prepare("UPDATE $tabla SET calificacion = :calificacion, comentario = :comentario WHERE id = :id");
	...
	static public function mdlMostrarDeseos($tabla, $item){
		...
		$stmt = Conexion2::conectar2()->prepare("SELECT * FROM $tabla WHERE id_usuario = :id_usuario ORDER BY id DESC");
